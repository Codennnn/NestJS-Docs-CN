...
| 样式           | 特点                                     | 示例图                                                                                   |
| :------------- | :--------------------------------------- | :--------------------------------------------------------------------------------------- |
| `json`（默认） | 结构化 JSON 格式，便于日志收集工具解析   | <DocImage src="/assets/Terminus_Error_Log_Json.png" alt="Terminus Error Log Json" />     |
| `pretty`       | 美化的可读格式，带颜色高亮，便于开发调试 | <DocImage src="/assets/Terminus_Error_Log_Pretty.png" alt="Terminus Error Log Pretty" /> |
