...
<DocImage src="/assets/devtools/modules-graph.png" alt="模块依赖图" />
...
<DocImage src="/assets/devtools/classes-graph.png" alt="类依赖图" />
...
<DocImage src="/assets/devtools/node-popup.png" alt="节点弹出窗口" />
...
<DocImage src="/assets/devtools/subtree-view.png" alt="子树视图" />
...
<DocImage src="/assets/devtools/drag-and-drop.png" alt="Drag and drop" />

上传成功后，你将看到如下依赖图与提示对话框：

<DocImage
  src="/assets/devtools/partial-graph-modules-view.png"
  alt="Partial graph modules view"
/>
...
<DocImage
  src="/assets/devtools/partial-graph-classes-view.png"
  alt="Partial graph classes view"
/>
...
<DocImage src="/assets/devtools/routes.png" alt="Routes" />
...
<DocImage src="/assets/devtools/sandbox.png" alt="Sandbox" />
...
<DocImage src="/assets/devtools/sandbox-table.png" alt="Sandbox table" />
...
<DocImage
  src="/assets/devtools/bootstrap-performance.png"
  alt="Bootstrap performance"
/>
...
<DocImage src="/assets/devtools/audit.png" alt="Audit" />
