...
<CalloutInfo>
  如果你使用过 [Angular](https://angular.dev/)
  框架，可能对「[懒加载模块](https://angular.dev/guide/ngmodules/lazy-loading#lazy-loading-basics)」这一概念比较熟悉。但需要特别注意：**Nest
  的懒加载机制与 Angular
  完全不同**，两者虽然名字相似，但底层原理和实现方式并不相同。
</CalloutInfo>
